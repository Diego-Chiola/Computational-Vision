...
\subsection{Sparse vs. Dense Correspondences}
...
\subsection{The Block Matching Algorithm (Dense Correspondences)}
...
\subsection{Left-Right Consistency and Occlusions}
